...
as a mechanism for reified (in-language) Incremental Modularity,
...
modularly and incrementally combine partial specifications of programs@xnote["."]{
...
In section 4, we explain what we mean by Internal Incremental Modularity,
...
you would still have to also specifically shoe-horn incrementality into the paradigm
...
@subsection{Internal Incremental Modular Specification}
...
is that of (incremental and modular partial)
...
that may be neither a record nor a record type; it cannot be incrementally extended or composed
...
more modularity, more incrementality, inside the language—and at runtime.
...
merely with the notion of specification and target.
...
(And we already mentioned above our also avoiding “class”.)
...
Also, pioneers provide inspiration, insight and discoveries, but seldom well rounded theories,
that only come after lots of experience, filtering, and reformulation.}]
...
Mixin inheritance also maps directly to the concepts of Modularity and Incrementality we are discussing,
...
For these reasons its adoption remains relatively obscure,
yet it still has outsized outreach, in languages like
...
One may also construe the way C++ duplicates non-“virtual” superclasses
as a form of mixin inheritance with automatic renaming,
at which point Mixin Inheritance is actually very popular, just not well-known.
...
while old reflective Class OO systems @~cite{Kahn1976 Kamin1988 gabriel1991clos AMOP}
...
once when the structure is set@xnote["."]{
...
But lacking direct access to those authors’ brains, out explanations must remain speculative.
...
Computer Scientists studying it may have too focused on the specifics of SELF
to conceptualize a more general notion of Prototype beyond it,
...
@section{OO as Internal Incremental Modularity}
...
Reduce complexity.
Compare with FP, which is pure modularity without incrementality:
