...
Slides for presentation at Seton Hall University, 2025-03-21

To compile it, use:
  racket slides-2025-shu.rkt > build/slides-2025-shu.html
...
"]}
    ...
    ($section "Introduction: In Lieu of a Presentation"
     ...
     ($slide "The Talk I Won’t be Giving Today"
        @Li{Redo of Scheme Workshop 2021}
        @Li{Redo of LambdaConf 2024}
        @Li{In Depth Presentation of Prototypes}
        @Li{In Depth Much Anything}
        @Li{Computer Science})
     ($slide "The Talk I’ll Be Giving Instead"
        @Li{Extension of NJPLS 2023}
        @Li{Why care about Prototype OO}
        @Li{A Taste of Prototype OO} ;; to tempt you to care
        @Li{Insights learned along the way} ;; @Li{How (not) to be a Good Researcher}
        @Li{Computing Arts})
